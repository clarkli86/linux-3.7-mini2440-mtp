...
*/
	ret = config_ep_by_speed(f->config->cdev->gadget, f, dev->ep_in);
    if(ret)
    {
...
*/
	if (ret)
		return ret;
	ret = config_ep_by_speed(f->config->cdev->gadget, f, dev->ep_out);
    if(ret)
    {
...
*/
	...
	ret = config_ep_by_speed(f->config->cdev->gadget, f, dev->ep_intr);
    if(ret)
    {
